...
import com.elmirov.weatherappcompose.extension.formattedFullDate
import com.elmirov.weatherappcompose.extension.formattedShortDayOfWeek
    ...
    Scaffold(
        ...
        Box(
            ...
            when (val forecastState = state.forecastState) {
                ...
                is DetailsStore.State.ForecastState.Loaded -> Loaded(forecast = forecastState.forecast)
...
private fun Loaded(forecast: Forecast) {
    Column(
        ...
        Row(
            ...
            Text(
                text = forecast.currentWeather.tempCelsius.tempToFormattedString(),
...
private fun RowScope.SmallWeatherCard(weather: Weather) {
    Card(
        ...
        Column(
            ...
            Text(text = weather.tempCelsius.tempToFormattedString())
            GlideImage(
                modifier = Modifier
                    .size(48.dp),
